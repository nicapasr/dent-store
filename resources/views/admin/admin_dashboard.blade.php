                ...
                <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{$item->b_value}} {{$item->materials->materialUnit->unit_name}}
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
            ...
            <div class="table-responsive">
                ...
                <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-red">
                                {{ConvertDateThai::toDateThai($item->b_exp_date)}}
                            </td>
                            <td>
                                {{$item->materials->m_code}}
                            </td>
                ...
                <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {{-- <td>
                                {{$item->materials->materialType->type_name}}
                            </td> --}}
                        </tr>
                        @endforeach
                    </tbody>
